...
template = pn.template.FastListTemplate(
    ...
    pn.Row(pn.Column(pn.pane.Markdown('## Barplot '),dashboard.plot_barplot_stuck,dashboard.param.gender_parent)),
...
template = pn.template.FastListTemplate(
    sidebar_width=200,
    main=[
        pn.Row(dashboard.plot_barplot_stuck, pn.Param(dashboard.param.gender_parent, widgets={'gender_parent':pn.widgets.Select}))
    ],